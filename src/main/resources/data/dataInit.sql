insert into users(is_subscription, role, id, address, email, first_name, image, last_name, password,
                  phone_number)
values (false, 'ADMIN', 1, 'Asia 7', 'davran@gmail.com', 'Davran', 'img', 'Joldoshabev',
       ...
       (true, 'USER', 2, 'Красный речка', 'salymbek@gmail.com', 'Salymbek', 'img',
        ' Khadzhakeldyev',
...
insert into sub_products (article_number, price, quantity, ram, rom, id, product_id,
                          additional_features, code_color,
...
insert into smart_watches (display_discount, waterproof, id, sub_product_id, an_interface, gender,
                           hull_shape,
...
insert into user_recently_viewed_products (recently_viewed_products, user_id)
values (1, 4),
       (2, 4),
       (1, 3),
       (4, 3)
